...
<div class="am-cf admin-main">
  <div class="admin-content" style="height: auto;padding:10px" >
    <jsp:include flush="true"
                 page="/getMenu.do?jmenuId=nav&jnodeId=personalNav&resultPage=/common/personalNav&match=${requestScope['javax.servlet.forward.servlet_path']}%3F${fn:replace(pageContext.request.queryString,'&','%26')}"/>
