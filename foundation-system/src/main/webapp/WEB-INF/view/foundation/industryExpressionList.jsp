...
<body>
  <div class="am-g">
    <div style="text-align: left;margin-bottom: 10px">
      <a type="button" class="am-btn am-btn-default am-btn-xs" href="<c:url value="/basic/xm.do?qm=formIndustryExpression"/>"><span class="am-icon-plus"></span>新建公式</a>
    </div>
    ...
    <div class="am-u-sm-12">
      <table class="am-table am-table-striped am-table-hover table-main">
        ...
        <tr>
          ...
          <th class="table-title">变量名称</th>
          <th class="table-title">表达式</th>
            ...
            <div class="am-btn-toolbar">
              <div class="am-btn-group am-btn-group-xs">
                <a class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"
                   href="<c:url value="/basic/xm.do?qm=formIndustryExpression&id=${obj.id}"/>"><span
                        class="am-icon-trash-o">修改</span>
                </a>
                <a class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"
                   href="<c:url value="/basic/xm.do?qm=formIndustryChoiceSetting"/>"><span
                        class="am-icon-trash-o">仿真</span>
                </a>
              </div>
            </div>
          </td>
