...
<form class="am-form am-form-horizontal" action="<c:url value="/basic/xm.do"/>">
  ...
  <div class="am-form-group">
    <label for="doc-ipt-pwd-2" class="am-u-sm-2 am-form-label">初始值</label>
    <div class="am-u-sm-10">
      <input type="text" name="initialValue" value="${object.initialValue}" id="doc-ipt-pwd-2">
    </div>
  </div>

  <div class="am-form-group">
    <label for="doc-ipt-pwd-2" class="am-u-sm-2 am-form-label">步长</label>
    <div class="am-u-sm-10">
      <input type="text" name="step" value="${object.step}" id="doc-ipt-pwd-2">
    </div>
  </div>
